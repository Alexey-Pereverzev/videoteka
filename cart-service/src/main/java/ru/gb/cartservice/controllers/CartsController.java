...
public class CartsController {
    ...
    @GetMapping("/add")
    public StringResponse add(@RequestHeader(required = false) String userId,  @RequestParam  String uuid,  @RequestParam  Long filmId,  @RequestParam  String filmTitle,  @RequestParam String filmImageUrlLink,  @RequestParam  int  rentPrice, @RequestParam  int  salePrice, @RequestParam boolean isSale ) {

        return cartService.addToCart(getCurrentCartUuid(userId, uuid), userId, filmId, filmTitle, filmImageUrlLink, salePrice, rentPrice, isSale);
    }
